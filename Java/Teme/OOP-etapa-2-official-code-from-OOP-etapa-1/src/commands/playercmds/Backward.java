...
public final class Backward implements CommandRunner {
    ...
    public ObjectNode execute(final CommandInput commandInput) {
        String message = backwardMessage(commandInput);
     ...
     */
    public static String backwardMessage(final CommandInput commandInput) {
