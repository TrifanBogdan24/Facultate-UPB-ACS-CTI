...
import command.execution.commands.AddRemoveInPlaylist;

public final class FactoryAddRemoveInPlaylist implements FactoryCommand {
    @Override
    public Command createCommand(final CommandInput commandInput) {
        return new AddRemoveInPlaylist();
    }
}
