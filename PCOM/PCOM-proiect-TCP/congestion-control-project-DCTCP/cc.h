...
public:
    ...
    double _alpha;
    double _g;
    /*total number of packets received in a window*/
    uint32_t _packets_count;
    /*number of packets received which were marked as ecn*/
    uint32_t _ecn_packets_count;

    /*increase*/
    double _cwnd_floor;

    /**/
    double _cwnd_shrink_factor;
    double _cwnd_growth_factor;
    //------------------------------
